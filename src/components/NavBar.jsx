  ...
  return (
    <nav className='hidden sm:flex ml-[32px]  bg-white/5 h-[96px] max-w-[768px] backdrop-blur-xl  grow  text-white tracking-wide '>
      <ul className='flex grow items-center gap-[48px] justify-end pr-[40px] *:font-barlow group'>
        <li className='h-full cursor-pointer flex items-center group-has-[.active]:border-b-2 group-has-[.active]:border-white  hover:border-b-2 hover:border-b-white/50'>
          <NavLink
            to='/'
            className={(isActive) =>
        ...
        <li
          className='h-full cursor-pointer flex items-center  border-b-2 border-transparent 
